...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full md:max-w-[430px] mx-auto relative">
      {/* Search Screen */}
      {currentScreen === 'search' && (
        <div className="mobile-full-height bg-gradient-to-b from-blue-600 to-blue-700 pb-20 flex flex-col">
          <div className="flex-1">
            <div className="px-5 pt-safe pt-6">
              <h1 className="text-white text-2xl font-bold mb-1.5">Find Hotels</h1>
              <p className="text-blue-100 text-xs">Search for perfect stays</p>
            </div>
            ...
            <div className="px-5 mt-6">
              ...
              <button
                ...
                className="w-full bg-white rounded-xl p-3.5 mb-2.5 text-left shadow-sm active:scale-[0.98] transition-transform"
              >
                <div className="text-[10px] text-gray-500 mb-0.5">Destination</div>
              ...
              <button
                ...
                className="w-full bg-white rounded-xl p-3.5 mb-2.5 shadow-sm active:scale-[0.98] transition-transform"
              >
                <div className="text-[10px] text-gray-500 mb-1">Dates</div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="text-[9px] text-gray-500">Check-out</div>
              ...
              <button
                ...
                className="w-full bg-white rounded-xl p-3.5 mb-4 shadow-sm active:scale-[0.98] transition-transform"
              >
                <div className="text-[10px] text-gray-500 mb-0.5">Guests & Rooms</div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Users className="w-4 h-4 text-blue-600" />
                    <span className="font-semibold text-sm">{guests} {guests === 1 ? 'Guest' : 'Guests'}, {rooms} {rooms === 1 ? 'Room' : 'Rooms'}</span>
                  </div>
                  <ChevronRight className="w-4 h-4 text-gray-400" />
                </div>
              </button>
              ...
              <button
                ...
                className="w-full bg-white text-blue-700 font-bold py-3.5 rounded-xl shadow-lg active:scale-[0.98] transition-transform text-base"
              >
                Search Hotels
              </button>
            </div>
          ...
          {/* Footer */}
          <div className="px-4 pb-safe pb-4 mt-auto">
            <p className="text-center text-blue-200 text-[10px] leading-relaxed">
              Developed by Ghada<br />
              Course IS1474 2026
            </p>
          </div>
        </div>
      ...
      {currentScreen === 'results' && (
        <div className="mobile-full-height bg-gray-50 pb-20">
          {/* Header */}
          <div className="bg-white px-4 py-3 pt-safe shadow-sm sticky top-0 z-10">
            <div className="flex items-center gap-2.5">
              <button onClick={() => setCurrentScreen('search')} className="active:scale-95 transition-transform">
                <ChevronLeft className="w-5 h-5 text-gray-700" />
              </button>
              <div className="flex-1">
                <h2 className="font-bold text-base">Hotels in {destination}</h2>
                <p className="text-[10px] text-gray-500">{checkIn} - {checkOut}</p>
              </div>
              <button
