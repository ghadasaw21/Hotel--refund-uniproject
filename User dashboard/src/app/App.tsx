...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full max-w-[428px] mx-auto relative">
      {/* Search Screen */}
        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-600 to-blue-700 flex flex-col">
          ...
          <div className="px-4 pb-6 mt-auto">
            <p className="text-center text-blue-200 text-[10px] leading-relaxed">
              Developed by <a href="https://www.linkedin.com/in/ghada-faisal-788728262" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors">Ghada</a><br />
              Course IS1474 2026
            </p>
          </div>
        </div>
